...
class Bird{
    ...
    * */
    ...
    birdMove(){
        ...
        if(this.birdImg.offsetTop<0 || this.birdImg.offsetTop>this.birdImg.parentElement.parentElement.clientHeight-this.birdImg.clientHeight){
...
class GameRun{
    ...
    * */
    ...
    add(parent){
        ...
        Object.assign(this.grass.grassView.style,{
